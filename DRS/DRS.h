...
#define REG_STAT_CONFIG              0x00020    // DRS4 Eval4 FW>533F
...
#define REG_LATCH_DELAY		           0x00022    // RWTH FW>533E
#define REG_FIXED_RATE		           0x00026    // RWTH FW>533F
...
#define REG_STOP_WSR0                0x00010 // (<<8 offset)
#define REG_FIRED_TRIG		           0x00010   // TRG SOURCE: RWTH FW>533E // (<<0..7 offset) ABCDE.F  (ABCD, Ext, ., FirstTrig)
#define REG_TRG_SOURCE		           0x00010   // TRG SOURCE: RWTH FW>533E // (<<0..7 offset) ABCDE.F  (ABCD, Ext, ., FirstTrig)
#define REG_STOP_WSR1                0x00011
#define REG_STOP_WSR2                0x00012
#define REG_STOP_WSR3                0x00013
#define REG_TIME_CO0                 0x00014  //RWTH FW>533D: [1]
#define REG_TIME_CO1                 0x00016  //RWTH FW>533D: [0]
#define REG_TIME_CO2                 0x00018  //RWTH FW>533D: [3]
#define REG_TIME_CO3                 0x0001A  //RWTH FW>533D: [2]
...
protected:
   ...
   int                  fLatchDelay;
   double               fLatchDelayNs;
   int                  fFixedRateDelay;
   double               fFixedRateDelayNs;
   int                  fSyncDelay;
   int                  fDelayedStart;
   int                  fTranspMode;
   int                  fDecimation;
...
public:
   ...
   void         PrintRegisters(FILE* f = stdout);
   ...
   void					SetLatchDelay(int delay);
   void					SetLatchDelayNs(int delay);
   int					GetLatchDelay() { return fLatchDelay;}
   int					GetLatchDelayNs() { return fLatchDelayNs;}
   void					SetFixedRateDelay(int delay);
   int					GetFixedRateDelay() { return fFixedRateDelay; }
   int					GetFixedRateDelayNs() { return fFixedRateDelayNs; }
   ...
   int          SetStatusSource(int source);
   int          GetStatusSource() { return fStatusSource; }
   ...
   unsigned long long GetFirstTriggerTime();
   int		GetFiredTrigger();
